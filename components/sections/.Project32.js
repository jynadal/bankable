          ...
          <div className="row">
            ...
            <div className="col-md-12">
              <div className="container_inner">
                <div
                  className="swiper-container slider-11"
                  data-aos="fade-in"
                    ...
                    <SwiperSlide>
                      <div className="project-box-style6">
                        ...
                        <div className="img-box">
                          <div className="image">
                            <img
                              src="/assets/images/common/project_22.jpg"
                              alt=""
                            />
                          </div>
                          <div className="content">
                            <div className="img-box">
                              <div className="image_inner">
                                <img
                                  className="mask"
                                  src="/assets/images/common/project_24.png"
                                  alt=""
                                />
                                <div className="shape">
                                  <img
                    ...
                    <SwiperSlide>
                      <div className="project-box-style6">
                        ...
                        <div className="img-box">
                          <div className="image">
                            <img
                              src="/assets/images/common/project_23.jpg"
                              alt=""
                            />
                          </div>
                          <div className="content">
                            <div className="img-box">
                              <div className="image_inner">
                                <img
                                  className="mask"
                                  src="/assets/images/common/project_25.png"
                                  alt=""
                                />
                                <div className="shape">
                                  <img
                ...
                <div className="next_slider-11 next_slider">
                  <svg
                    width={18}
                    height={16}
                    viewBox="0 0 18 16"
                ...
                <div className="prev_slider-11 prev_slider">
                  <svg
                    width={18}
                    height={16}
                    viewBox="0 0 18 16"
