        ...
        <div className="container w_1280">
          <div className="row">
            <div className="col-md-12">
              ...
              >
                <h2 className="title">project22 we recommend</h2>
              </div>
            </div>
            <div className="col-md-12">
              <div
                ...
                <div className="content-tab">
                  ...
                  >
                    <div className="container_inner">
                      <div
                        className="swiper-container slider-3"
                        data-aos="fade-in"
                        data-aos-duration={1000}
                      >
                          ...
                          <SwiperSlide>
                            <div className="project-box-style4">
                              <div className="image">
                                <div className="img_inner">
                                  <img
                                    src="/assets/images/common/project_13.png"
                                    alt=""
                                  />
                                  <img
                                    className="shape"
                              ...
                              <div className="content">
                                <h5 className="heading">
                                  <Link href="/project-grid">Oddmar</Link>
                                </h5>
                                <p className="desc">
                                  Lorem ipsum dolor sit amet, consectetur
                                  adipiscing elit. Praesent varius risus sed
                                  pellentesque
                                </p>
                                <ul>
                                  <li>
                            ...
                            <div className="project-box-style4">
                              <div className="image">
                                <div className="img_inner">
                                  <img
                                    src="/assets/images/common/project_14.png"
                                    alt=""
                                  />
                                  <img
                                    className="shape"
                              ...
                              <div className="content">
                                <h5 className="heading">
                                  <Link href="/project-grid">Fruit Ninja</Link>
                                </h5>
                                <p className="desc">
                                  Lorem ipsum dolor sit amet, consectetur
                                  adipiscing elit. Praesent varius risus sed
                          ...
                          <SwiperSlide>
                            ...
                            <div className="project-box-style4">
                              <div className="image">
                                <div className="img_inner">
                                  <img
                                    src="/assets/images/common/project_16.png"
                                    alt=""
                                  />
                                  <img
                                    className="shape"
                      ...
                      <div className="next_slider-3 next_slider">
                        <svg
                          width={18}
                          height={16}
                          viewBox="0 0 18 16"
                      ...
                      <div className="prev_slider-3 prev_slider">
                        <svg
                          width={18}
                          height={16}
                          viewBox="0 0 18 16"
                  ...
                  >
                    <div className="container_inner">
                      <div
                        className="swiper-container slider-4"
                        data-aos="fade-in"
                        data-aos-duration={1000}
                      >
                      ...
                      <div className="next_slider-4 next_slider">
                        <svg
                          width={18}
                          height={16}
                          viewBox="0 0 18 16"
                      ...
                      <div className="prev_slider-4 prev_slider">
                        <svg
                          width={18}
                          height={16}
                          viewBox="0 0 18 16"
                  ...
                  >
                    <div className="container_inner">
                      <div
                        className="swiper-container slider-5"
                        data-aos="fade-in"
                        data-aos-duration={1000}
                      >
                      ...
                      <div className="next_slider-5 next_slider">
                        <svg
                          width={18}
                          height={16}
                          viewBox="0 0 18 16"
                      ...
                      <div className="prev_slider-5 prev_slider">
                        <svg
                          width={18}
                          height={16}
                          viewBox="0 0 18 16"
