            ...
            <SwiperSlide>
              <div className="slider-st2">
                <img
                  ...
                  src="/assets/images/common/icon1_slider_2.png"
                  alt=""
                />
                <img
                ...
                <img
                  ...
                  src="/assets/images/common/icon3_slider_2.png"
                  alt=""
                />
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="box-slider">
                        <div className="content-box">
                          <h1 className="title">
                            Being an early investor in the top Blockchain
                            ecosystem, NFTs and Movies
                          </h1>
                          <p className="sub-title">
                            Do you want to be the early movies collectioner. the
                            leading blockchain gaming launchpad with over 50
                            projects launched and the highest average ROI in the
                            industry
                          </p>
                          <div className="wrap-btn">
