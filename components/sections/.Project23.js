        ...
        <div className="container w_1280">
          <div className="row">
            <div className="col-md-12">
              ...
              >
                <h2 className="title">Completed Project 23</h2>
              </div>
            </div>
            <div className="col-md-12">
              <div className="container_inner">
                <div
                  className="swiper-container slider-8"
                  data-aos="fade-in"
                      ...
                      <div className="project-box-style5">
                        ...
                        <div className="img-box">
                          <div className="image">
                            <img
                              className="mask"
                              src="/assets/images/common/project_21.png"
                              alt=""
                            />
                            <div className="shape">
                              <img
                            ...
                            >
                              <p className="progress-title-holder">
                                <span className="progress-title">
                                  ...
                                  <span>
                                    Max Participants{' '}
                                    <span className="white">4472</span>
                                  </span>
                                </span>
                              </p>
                ...
                <div className="next_slider-8 next_slider">
                  <svg
                    width={18}
                    height={16}
                    viewBox="0 0 18 16"
                ...
                <div className="prev_slider-8 prev_slider">
                  <svg
                    width={18}
                    height={16}
                    viewBox="0 0 18 16"
