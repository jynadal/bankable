        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-10 col-md-9">
              ...
              >
                <h2 className="title">
                  Project4 have been excellently successful
                </h2>
              </div>
            </div>
              ...
              <div className="project-box-style3_wrapper">
                ...
                >
                  <div className="header_project">
                    ...
                    <h5 className="heading">
                      <Link href="/project-list">Codyfight IGO</Link>
                    </h5>
                  </div>
                  <div className="content">
                    <div className="td td1">
                ...
                >
                  <div className="header_project">
                    <div className="image">
                      <img
                        className="mask"
                        src="/assets/images/common/project_10.png"
                        alt=""
                      />
                      <div className="shape">
                        <img src="/assets/images/common/shape_2.png" alt="" />
                    ...
                    <h5 className="heading">
                      <Link href="/project-list">Asphalt="" 9: Legends</Link>
                    </h5>
                  </div>
                  <div className="content">
                    <div className="td td1">
                ...
                >
                  <div className="header_project">
                    ...
                    <h5 className="heading">
                      <Link href="/project-list">Garena Free Fire MAX</Link>
                    </h5>
                  </div>
                  <div className="content">
                    <div className="td td1">
