          ...
          <div className="row">
            ...
            <div className="col-md-12">
              <div className="container_inner roadmap_boder">
                    ...
                    <Swiper {...swiperOptions} className="swiper-wrapper">
                      <SwiperSlide>
                        <div className="roadmap-box active">
                          ...
                          <div className="content">
                            ...
                            <ul>
                              <li>Making our movies collection for minting</li>
                              <li>
                                Bankable.movie and dMovies for early adopters
                              </li>
                              <li>VDTK PoR and minting dMovies</li>
                            </ul>
                          </div>
                        </div>
                      </SwiperSlide>
                      ...
                      <SwiperSlide>
                        <div className="roadmap-box active">
                          ...
                          <div className="content">
                            ...
                            <ul>
                              <li>Increase movies collection</li>
                              <li>
                                Airstream on Samsung smartTV and one Internet
                                provider
                              </li>
                              <li>
                      ...
                      <SwiperSlide>
                        <div className="roadmap-box">
                          ...
                          <div className="content">
                            <h6 className="date">March , 2025</h6>
                            <ul>
                              <li>
                                Cras molestie ullamcorper augue nec pulvinar
                              </li>
                      ...
                      <SwiperSlide>
                        <div className="roadmap-box">
                          ...
                          <div className="content">
                            <h6 className="date">June , 2025</h6>
                            <ul>
                              <li>
                                Cras molestie ullamcorper augue nec pulvinar
                              </li>
                      ...
                      <SwiperSlide>
                        <div className="roadmap-box">
                          ...
                          <div className="content">
                            <h6 className="date">September , 2025</h6>
                            <ul>
                              <li>
                                Cras molestie ullamcorper augue nec pulvinar
                              </li>
                      ...
                      <SwiperSlide>
                        <div className="roadmap-box">
                          ...
                          <div className="content">
                            <h6 className="date">December , 2025</h6>
                            <ul>
                              <li>
                                Cras molestie ullamcorper augue nec pulvinar
                              </li>
                      ...
                      <SwiperSlide>
                        <div className="roadmap-box">
                          ...
                          <div className="content">
                            <h6 className="date">March , 2026</h6>
                            <ul>
                              <li>
                                Cras molestie ullamcorper augue nec pulvinar
                              </li>
                ...
                <div className="next_slider-7 next_slider">
                  <svg
                    width={18}
                    height={16}
                    viewBox="0 0 18 16"
                ...
                <div className="prev_slider-7 prev_slider">
                  <svg
                    width={18}
                    height={16}
                    viewBox="0 0 18 16"
