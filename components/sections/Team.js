            ...
            <div className="col-md-12">
              <div className="team-box-wrapper">
                ...
                >
                  <img
                    className="shape"
                    src="/assets/images/common/shape_3.png"
                    alt=""
                  />
                  <img
                    className="shape_ecfect"
                    src="/assets/images/common/shape_4.svg"
                    alt=""
                  />
                  <div className="image">
                  ...
                  <div className="content">
                    <h5 className="name">
                      <Link href="/team-details">Jean Yves Nadal</Link>
                    </h5>
                ...
                >
                  ...
                  <div className="content">
                    <h5 className="name">
                      <Link href="/team-details">Vincent B.</Link>
                    </h5>
                ...
                >
                  ...
                  <div className="content">
                    <h5 className="name">
                      <Link href="/team-details">Michael</Link>
                    </h5>
                    <p className="position">Specialist AI & Blockchain</p>
                    <ul className="social">
                      <li>
                        <Link href="#">
                          <svg
