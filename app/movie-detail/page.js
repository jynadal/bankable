...
export default async function ProjectDetails({ movieParams }) {
  const _idMovie = movieParams?._id;
  const _id = Number(_idMovie);
  const itemA = await getSingleMovie(_id);

  const movie = itemA.props.singleMovie;
            ...
            <div className="container">
              <div className="row">
                ...
                >
                  {/* <Image
                    //className="mask"
                    src="/public/assets/images/bankablePictures/titanic1.png"
                    width={100}
                    height={250}
                    alt=""
                  > */}
                  <div className="project_detail project-box-style5">
                    ...
                    <div className="img-box">
                      ...
                      <div className="content">
                        <h5 className="heading">Titanic</h5>
                        <p className="desc">12 / 100</p>
                      </div>
                    </div>
                    <div className="content-inner">
                      <p className="sub">A James Cameron film, 1998 year</p>
                      {/* <div className="kyc">
                        <div className="icon">
                          <svg
                            width={24}
                      ...
                      <div className="total">
                        <p>Bought 1 month ago at</p>
                        <p className="active">44 Matic</p>
                      </div>
                    </div>
                  </div>
                  {/* </Image> */}
                ...
                >
                  <div className="prodect-content">
                    ...
                    <h4 className="heading">
                      Sell film btn ............ Add Wishlist / Add Favory btn
                    </h4>
                    <h4 className="heading mb10"></h4>
                    ...
                    <div className="box">
                      <p>
                        ...
                        elementum vitae. Nulla eget fermentum dolor. Sed quis
                        ante iaculis, consequat odio eget.
                      </p>
                      <h4 className="heading mb10">1. All caracters</h4>
                      <p>
                      ...
                      <p>
                        Nulla sed ex in magna ullamcorper lacinia. Maecenas
                        maximus sagittis tellus, ac hendrerit ex. Maecenas ut
                        bibendum ex, at luctus velit. Vestibulum sit amet neque
                        odio. Suspendisse nisl odio, accumsan at ante at,
                        ultrices mollis augue. Morbi id lorem elementum,
                        interdum velit eu, pellentesque felis. Morbi tincidunt
                        ultrices felis sed vulputate. Etiam non nisl congue,
                        ultricies augue eget, tristique enim.
                      </p>
                      <ul>
                        <li>
                          <span>
                            Praesent fringilla, purus quis congue rutrum, tortor
                            ligula egestas justo, eu venenatis erat tellus ut
                            risus. Nam elit magna, facilisis nec iaculis id
                          </span>
                        </li>
                        <li>
                          <span>
                            Fusce id erat rutrum, dignissim diam eget, finibus
                            odio. Aenean porta lacus suscipit urna luctus
                            luctus.
                          </span>
                        </li>
                        <li>
                          <span>
                            Maecenas ut bibendum ex, at luctus velit. Vestibulum
                            sit amet neque odio
                          </span>
                        </li>
                        <li>
                    ...
                    <div className="box">
                      <h4 className="heading mb10">
                        2.1 Go-to-market strategy
                      </h4>
                      <p>
                        Morbi id lorem elementum, interdum velit eu,
                        pellentesque felis. Morbi tincidunt ultrices felis sed
                        vulputate. Etiam non nisl congue, ultricies augue eget,
                        tristique enim.
                      </p>
                    </div>
                    <div className="box">
                      ...
                      <p>
                        Sed quis velit tortor. Nam fermentum vehicula gravida.
                        Mauris rhoncus sagittis congue. Mauris euismod erat et
                        neque finibus scelerisque. Fusce at egestas elit.
                        Curabitur elementum commodo quam, ut vulputate magna
                        consectetur et. Morbi luctus justo lacus, eget facilisis
                        augue pharetra a. Nullam in ullamcorper risus, et
                        fermentum mi. Quisque tincidunt felis sit amet tempor
                        tempor. Pellentesque hendrerit ultricies pellentesque.
                        Phasellus eu accumsan sem.
                      </p>
                    </div>
                    <div className="box">
                      <h4 className="heading mb10">3. Tokenomics</h4>
                      <p>
                        Cryptochi will rely on its token ($CTHG) to power its
                        game economy. Token use will involve but is not limited
                        to:
                      </p>
                      <ul className="mb14">
                        <li>
                      ...
                      <p>
                        Cryptochi aims to maintain a free market economy using
                        $CTHG as the underlying currency, with a continuous
                        demand for the currency as the in-game economy grows.
                        Players will capitalize on the growth and expansion of
                        their own resources as well as the growth of the in-game
                        economy, which will be reflected in the token value.
                      </p>
                    </div>
                    <div className="image mb30">
                      <img
                        className="boder-20"
                        src="/assets/images/common/details_2.jpg"
                        alt=""
                      />
                    </div>
                    <div className="box">
                      ...
                      <ul className="mb8">
                        ...
                        <li>
                          <span>
                            NFT creation Seed &amp; Private Round Fundraising
                          </span>
                        </li>
                      </ul>
                      ...
                      <ul className="mb8">
                        ...
                        <li>
                          <span>
                            Token Listing $CTHG &amp; ecosystem wrapping
                          </span>
                        </li>
                        <li>
                      ...
                      <ul className="mb14">
                        <li>
                          <span>
                            Beta version wipeout &amp; full game launch
                          </span>
                        </li>
                        <li>
                        ...
                        <li>
                          <span>
                            Affiliate program &amp; incentives release
                          </span>
                        </li>
                        <li>
                    ...
                    <div className="image mb30">
                      <img
                        className="boder-20"
                        src="/assets/images/common/details_3.jpg"
                        alt=""
                      />
                    </div>
                    <div className="box">
                      ...
                      <p>
                        Quisque congue placerat ipsum, sed tristique tellus
                        porta id. Aliquam erat volutpat. Nullam vel libero et
                        augue molestie ornare. In hac habitasse platea dictumst.
                        Fusce interdum feugiat fringilla.{' '}
                      </p>
                      <p>
                        Nulla facilisi. Suspendisse orci mi, cursus in posuere
                        eget, luctus ac augue. Sed blandit ligula at luctus
                        malesuada. Donec sodales augue vel ante rhoncus
                        pharetra. Nullam ac suscipit est, eu venenatis ante.
                        Cras scelerisque pulvinar risus, sed condimentum quam
                        venenatis sed. Integer aliquet neque odio, a iaculis
                        ante malesuada nec. Nulla a pretium augue.
                      </p>
                    </div>
                    <div className="box">
                      ...
                      <div className="team-box-style2">
                        ...
                        <div className="content">
                          ...
                          <p>
                            possesses a strong background in business
                            development and public relations. Has 5 years of
                            digital marketing experience, spent $10 million on
                      ...
                      <div className="team-box-style2">
                        ...
                        <div className="content">
                          ...
                          <p>
                            has been developing games since 2010, he is the
                            owner of a game studio and still maintains 5 online
                            games. He has extensive experience in game design,
                            computer programming, and blockchain technologies.
                          </p>
                        </div>
                      </div>
                      <div className="team-box-style2">
                        ...
                        <div className="content">
                          ...
                          <p className="position">
                            Concept Artist / Lead Designer
                          </p>
                          <p>
                            highly creative and multitalented concept artist
                            with 10 years of experience in multimedia,
                            game/characters designs.
                          </p>
                        </div>
                      </div>
                      <div className="team-box-style2">
                        ...
                        <div className="content">
                          ...
                          <p>
                            Reliable and passionate blockchain developer. Robert
                            has experience not only as a full-stack blockchain
                            developer but has also worked as a full-stack
                            developer before.
                          </p>
                        </div>
                      </div>
                      <div className="team-box-style2">
                        ...
                        <div className="content">
                          <h6 className="name">Jacob Jones</h6>
                          <p className="position">
                            Content manager and producer
                          </p>
                          <p>
                            with amazing financial and creative content
                            publishment strategies and background. Acherisium
                            manages all the content published by Cryptochi.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="image mb30">
                      <img
                        className="boder-20"
                        src="/assets/images/common/details_4.jpg"
                        alt=""
                      />
                    </div>
                    <div className="box">
                      ...
                      <div className="inner-box">
                        ...
                        <ul>
                          ...
                          <li>
                            <p>Lock-up:</p>
                            <p>
                              8% on TGE, 2 months cliff, 3rd - 6th months 3%,
                              7th - 10th 4%, 11th - 18th 5%, 19th - 22nd 6%.
                            </p>
                          </li>
                        </ul>
                      </div>
