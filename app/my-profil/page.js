...
import TrendingSlider from '@/components/sections/Slider';
              ...
              <div className="row">
                ...
                >
                  <div className="prodect-content">
                    <h4 className="heading">My movies</h4>
                    <p>
                    ...
                    <h6 className="heading">See all movies btn </h6>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  ...
                  >
                    <h2 className="title">
                      Ended iGGGGGGGGGGGGGGGGGGGGGGGggGGGGGGGOs
                    </h2>
                  </div>
                </div>
                <div className="col-md-12">
