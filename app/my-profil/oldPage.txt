            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  ...
                  >
                    <h2 className="title">My Movie Collection</h2>
                  </div>
                </div>
                <div className="col-md-12">
                    ...
                    <div className="content-wrapper">
                      ...
                      >
                        <div className="wrapper">
                          <h4>Will Smith</h4>
                          <p className="desc">
                            Ookeenga is the no.1 Vertical Multiplayer Real Time
                            Strategy Game with breathtaking 3D visuals...
                          </p>
                          <ul className="price">
                            <li>
                              <span>Price: $0.4</span>
              ...
              <div className="row">
                <div className="col-md-12">
                  <div
                    ...
                    data-aos-duration={800}
                  >
                    <h2 className="title">Completed pools</h2>
                  </div>
                </div>
                <div className="col-md-12">
                    ...
                    >
                      <div className="header_project">
                        <div className="image">
                          <img
                            className="mask"
                            src="/assets/images/common/project_9.png"
                            alt=""
                          />
                          <div className="shape">
                            <img
                    ...
                    >
                      <div className="header_project">
                        <div className="image">
                          <img
                            className="mask"
                            src="/assets/images/common/project_86.png"
                            alt=""
                          />
                          <div className="shape">
                            <img
                    ...
                    >
                      <div className="header_project">
                        <div className="image">
                          <img
                            className="mask"
                            src="/assets/images/common/project_11.png"
                            alt=""
                          />
                          <div className="shape">
                            <img
                    ...
                    >
                      <div className="header_project">
                        <div className="image">
                          <img
                            className="mask"
                            src="/assets/images/common/project_34.png"
                            alt=""
                          />
                          <div className="shape">
                            <img
                    ...
                    >
                      <div className="header_project">
                        <div className="image">
                          <img
                            className="mask"
                            src="/assets/images/common/project_33.png"
                            alt=""
                          />
                          <div className="shape">
                            <img
                    ...
                    >
                      <div className="header_project">
                        <div className="image">
                          <img
                            className="mask"
                            src="/assets/images/common/project_87.png"
                            alt=""
                          />
                          <div className="shape">
                            <img
