                  ...
                  <div className="post-details">
                    ...
                    <div className="content-inner">
                      ...
                      <div className="content-post">
                        ...
                        <p>
                          Meta is pitching the Quest Pro as a productivity
                          device, aimed at designers, architects and other
                      ...
                      <div className="wrapper-related-post">
                        <div className="grid-box">
                          ...
                          <div className="content">
                            ...
                            <h5 className="title">
                              <Link href="#">Tapping the Metaverse for...</Link>
                            </h5>
                            <p>
                              The metaverse can help the healthcare fraternity
                              by providing trainings on...
                            </p>
                          </div>
                        ...
                        <div className="grid-box">
                          ...
                          <div className="content">
                            ...
                            <h5 className="title">
                              <Link href="#">
                                People still don't know what metaverse is...
                              </Link>
                            </h5>
                            <p>
                              The metaverse can help the healthcare fraternity
                        ...
                        <div className="grid-box">
                          ...
                          <div className="content">
                            ...
                            <h5 className="title">
                              <Link href="#">
                                Microsoft brings animated avatars to ...
                              </Link>
                            </h5>
                            <p>
                              The metaverse can help the healthcare fraternity
                      ...
                      <li>
                        <div className="recent-posts">
                          ...
                          <div className="content">
                            ...
                            <Link href="/blog-list" className="title">
