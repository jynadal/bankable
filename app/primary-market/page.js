                      ...
                      >
                        ...
                        <div className="project-box-style4">
                          <div className="image">
                            <div className="img_inner">
                              <img
                                src="/assets/images/common/project_57.png"
                                alt=""
                              />
                              <img
                                className="shape"
                        ...
                        <div className="project-box-style4">
                          <div className="image">
                            <div className="img_inner">
                              <img
                                src="/assets/images/common/project_58.png"
                                alt=""
                              />
                              <img
                                className="shape"
                        ...
                        <div className="project-box-style4">
                          <div className="image">
                            <div className="img_inner">
                              <img
                                src="/assets/images/common/project_59.png"
                                alt=""
                              />
                              <img
                                className="shape"
                          ...
                          <div className="content">
                            <h5 className="heading">
                              <Link href="/project-details">Legend of Ace</Link>
                            </h5>
                            <p className="desc">
                              Ookeenga is the no.1 Vertical Multiplayer Real
                              Time Strategy Game with breathtaking 3D visuals...
                        ...
                        <div className="project-box-style4">
                          <div className="image">
                            <div className="img_inner">
                              <img
                                src="/assets/images/common/project_60.png"
                                alt=""
                              />
                              <img
                                className="shape"
                        ...
                        <div className="project-box-style4">
                          <div className="image">
                            <div className="img_inner">
                              <img
                                src="/assets/images/common/project_61.png"
                                alt=""
                              />
                              <img
                                className="shape"
                        ...
                        <div className="project-box-style4">
                          <div className="image">
                            <div className="img_inner">
                              <img
                                src="/assets/images/common/project_62.png"
                                alt=""
                              />
                              <img
                                className="shape"
                          ...
                          <div className="content">
                            <h5 className="heading">
                              <Link href="/project-details">Shadowmatic</Link>
                            </h5>
                            <p className="desc">
                              Ookeenga is the no.1 Vertical Multiplayer Real
                              Time Strategy Game with breathtaking 3D visuals...
                        ...
                        <div className="project-box-style4">
                          <div className="image">
                            <div className="img_inner">
                              <img
                                src="/assets/images/common/project_63.png"
                                alt=""
                              />
                              <img
                                className="shape"
                        ...
                        <div className="project-box-style4">
                          <div className="image">
                            <div className="img_inner">
                              <img
                                src="/assets/images/common/project_64.png"
                                alt=""
                              />
                              <img
                                className="shape"
                          ...
                          <div className="content">
                            <h5 className="heading">
                              <Link href="/project-details">8 Ball Blitz</Link>{' '}
                            </h5>
                            <p className="desc">
                              Ookeenga is the no.1 Vertical Multiplayer Real
                              Time Strategy Game with breathtaking 3D visuals...
